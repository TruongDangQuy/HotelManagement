...
namespace HotelManager.DTO
{
    public class Account
    {
        ...
        #region Constructor
        public Account() { }
        public Account(string userName, string displayName, string passWord, int staffType, string idCard, DateTime dateOfBirth, string sex, string address, int phoneNumber, DateTime startDay, string picture, int idStaffType)
        {
        ...
        public bool Equals(Account accountPre)
        {
            ...
            if(picture!=accountPre.picture)return false;
            return true;
        }
        #endregion
